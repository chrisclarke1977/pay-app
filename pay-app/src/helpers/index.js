...
export const randType = () => { return randomItem(["payment", "request", "received"])};

export const nPayment = (type) => { return {
      id: Math.random(),
      name: randName(),
      date: randDate().toString(),
      amount: Math.floor(Math.random()*100000),
      type: type
    }; 
};

export const aPayment = () => { return {
      id: Math.random(),
      name: randName(),
      date: randDate().toString(),
      amount: Math.floor(Math.random()*100000),
